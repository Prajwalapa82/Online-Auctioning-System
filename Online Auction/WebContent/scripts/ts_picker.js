...
//    for feature requests and/or donations
  ...
  function show_calendar(str_target, str_datetime) {
	...
	var str_buffer = new String (
		...
		"<tr>\n	<td bgcolor=\"lightblue\"><a href=\"javascript:window.opener.show_calendar('"+
		str_target+"', '"+ dt2dtstr(dt_prev_month)+"');\">"+
		"<img src=\"images/cal.jpg\" width=\"16\" height=\"16\" border=\"0\""+
		" alt=\"previous month\"></a></td>\n"+
		"	<td bgcolor=\"blue\" colspan=\"5\">"+
		"<font color=\"white\" face=\"tahoma, verdana\" size=\"2\">"
		+arr_months[dt_datetime.getMonth()]+" "+dt_datetime.getFullYear()+"</font></td>\n"+
		"	<td bgcolor=\"lihtblue\" align=\"right\"><a href=\"javascript:window.opener.show_calendar('"
	...
	while (dt_current_day.getMonth() == dt_datetime.getMonth() ||
		...
		for (var n_current_wday=0; n_current_wday<7; n_current_wday++) {
				if (dt_current_day.getDate() == dt_datetime.getDate() &&
					...
					// print current date
					str_buffer += "	<td bgcolor=\"lightblue\" align=\"right\">";
