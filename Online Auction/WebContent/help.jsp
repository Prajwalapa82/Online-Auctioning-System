...
<BR>
   <TR>
    <TD>
     <A href="index.jsp"><STRONG>
          <FONT color="maroon" FACE="CURLZ MT">HOME</STRONG>
     </A> </TD>    
    <TD>
    <A href="LoginForm.jsp"><STRONG> 
         <FONT color="maroon" FACE="CURLZ MT">LOGIN</STRONG>
     </A></TD>
        <TD>
    <A href="Registerform.jsp"><STRONG>
        <FONT color="maroon" FACE="CURLZ MT">REGISTER</STRONG>
     </A></TD>
	   <TD>
      <A href="./ForSale.jsp"><STRONG>
        <FONT color="maroon" FACE="CURLZ MT">CURRENT BID ITEMS</STRONG>
       </A></TD>
        <TD>
     <A href="./help.jsp"><STRONG>
        <FONT color="maroon" FACE="CURLZ MT">HELP</STRONG>
    </A></TD>
...
<strong>
<font color="marron"face="arial">SEARCH:</font> </strong>
...
</FORM>    <tr>     <td height="64" align="center">                     </td>
        </tr>
        <tr>
...
href="EndToday">Closing Items</A> <STRONG>|</STRONG> 
    ...
    <A 
href="index.jsp">Home</A> <STRONG>|</STRONG></p>
  <p>&nbsp;</p>
</CENTER>
</BODY></jsp>
